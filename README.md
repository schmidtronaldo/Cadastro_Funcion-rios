...
## Desafio de projeto
Para este desafio, Utilizei meus conhecimentos adquiridos no módulo de Nuvem com Microsoft Azure, da trilha .NET da DIO.
...
Algumas alterações em relação ao projeto original.
Em desenvolvimento...